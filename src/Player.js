...
const Buttons = (props) => {
  ...
  if (firstPlay === true) { // if it's the first time a track is played
  ...
  function nextPlay() {
    ...
    // get the next track
    (async () => {
      const SongsArray = await fetchTracks();
  ...
  return (<Box sx={{ flexGrow: 1 }}>
    <Grid alignItems="center" justifyContent="center" height="100vh" container spacing={2}>
...
export default function Player(props) {
  ...
  if (props.showPlayer === true) {
    ...
    return <div className="player" style={style}><Buttons firstPlay={props.firstPlay} setFirstPlay={props.setFirstPlay} currentTrack={props.currentTrack} nextTrack={nextTrack} mood={mood} /></div>
